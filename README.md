...
## Delete build folder in /android/app and then react-native run-android in terminal
##If you have error like
##unable to resolve module react/lib/ReactPropTypes
##you need to install react just run 
$: npm install react@16.0.0-alpha.6 --save
##if you have error
##Bug: undefined is not an object (evaluating ##'Orientation.lockToPortrait') || Landscape
##just run: 
$: react-native link react-native-orientation
##if you have error like
##':app:compileDebugJavaWithJavac'. > java.lang.NullPointerException
##just run: 
$: react-native upgrade 
##and answer all with y :D 
##Thank me later 
